...
- ✅ **Fase 3 completa** (28 may 2026). Panel admin probado end-to-end: login, dashboard adaptativo, listado de reservas con filtros, confirmar/rechazar (genera comisión 10% si gestor != null), calendario mensual, gestión de usuarios y edición de posadas/precios/temporadas. RLS validada: cada rol ve solo lo que le toca.
- 🚀 **Fase 4 desplegada** (28 may 2026). Módulos financieros (Gastos, Comisiones, Pagos por canal, Nómina con sueldos fijos + bonos, Reportes con CSV exportable). Sistema EN PRODUCCIÓN en `https://posadas-san-andres.vercel.app` con migraciones 014-015 aplicadas. MANUAL.md con guía paso a paso por rol.
